...
export function useFile() {
  ...
  // Returns { path } on success, null on cancel / failure (failure also
  // populates saveError). Callers (App.vue) inspect the return value to
  // show a success toast; on null, no toast is needed.
